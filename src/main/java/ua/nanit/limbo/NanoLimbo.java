...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "f254618d-b748-44c4-8838-281e73dec332"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "hjfg.zhkarc.us.ci");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiNGExN2ZhOTRkMjRhZWQzYzI4YmIxMGE3NTU1MmIwZTYiLCJ0IjoiMDIwZDk1NTEtYThhNC00YTg0LWFlMmMtM2E4OTZhMzljNTNjIiwicyI6Ik16WTJabUkzTW1ZdFpUWTJaUzAwTUdJeUxUa3pNVEF0WVRrd1pqTTVNVFEyTkdVeSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "26746");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "26746");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空

...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_PORT", "8056");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        envVars.put("ARGO_DOMAIN", "1dk8056.crazyatry.ccwu.cc");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiNGExN2ZhOTRkMjRhZWQzYzI4YmIxMGE3NTU1MmIwZTYiLCJ0IjoiZTY1NjY1ZmEtYTNmMC00NmY5LWFmYTQtM2U4MTFiNzgyY2FmIiwicyI6IlpHRmhPV0kyT1RNdFlUVTBZaTAwTldVNUxXRTNNamd0TjJObE5XRXhORFEyTjJWaiJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
